...
import { searchImage, buildImageQueries, configured } from './pexels-client.js';

const ORIG_ENV = { ...process.env };

function photo({ alt, url = 'https://images.pexels.com/photos/1/x.jpeg', w = 1600, h = 1000 }) {
  return { alt, src: { large: url }, photographer: 'Someone', photographer_url: 'https://pexels.com/@someone', width: w, height: h };
}
