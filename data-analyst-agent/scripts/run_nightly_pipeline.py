...
Insight Engine -> Recommendation Engine -> Predictive Alert Delivery. Each
stage reads only what the previous stage wrote (alert delivery reads the
Recommendation text the prior stage just wrote, when available). Run via
cron (see docker-compose.yml comment) as:
