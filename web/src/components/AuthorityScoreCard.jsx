  ...
  if (!authority) {
    return (
      <div className="flex items-center gap-3 rounded-3xl border border-amber-200/60 bg-gradient-to-r from-amber-500/[0.03] to-amber-500/[0.01] p-5 text-xs text-slate-500 font-semibold shadow-sm relative overflow-hidden min-h-[140px]">
        ...
        <span className="w-8 h-8 rounded-xl grid place-items-center bg-amber-500/10 text-amber-600 shrink-0">
          <AlertTriangle size={15} strokeWidth={2.5} />
        </span>
        <div className="min-w-0 flex-1">
          <span className="font-black text-amber-700 block text-[10px] uppercase tracking-wider mb-0.5">Configuration Pending</span>
